...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
		// 1-Setup phase
		double balanceBefore = SimpleBankingApp.getBalance("5495-1234");
		double withdrawalAmount = 100.25;
		...
		if(balanceBefore - withdrawalAmount == balanceAfter)
			...
			System.out.println(TestUtils.TEXT_COLOR_RED + "testWithdrawals: TC2 FAILED XXX: balanceBefore - withdrawalAmount != balanceAfter" + TestUtils.TEXT_COLOR_RESET);
